...
export class FormationService {
    ...
    getFormations(): Observable<Array<Formation>> {
        // let url = "https://rdv-candidat.herokuapp.com/formations";http://localhost:4201/
        const url = "http://localhost:4567/formations";
        console.log("URL = " + url);
